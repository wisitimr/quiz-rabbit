...
-- ============================================================
-- ข้อมูลตัวอย่าง: ธีม, ตัวละคร, แคมเปญ, และ 10 คำถามพร้อมตัวเลือก
-- ============================================================
...
-- 2) สร้างตัวละคร "Bunny" พร้อม asset URLs
...
-- 3) สร้างแคมเปญ "General Knowledge"
INSERT INTO quiz_campaigns (id, slug, title, description, theme_id, character_id, max_questions, time_per_question_sec) VALUES
(1, 'general-knowledge', 'ความรู้รอบตัว', 'ทดสอบความรู้ทั่วไปกับน้องกระต่าย', 1, 1, 10, 30);

-- ============================================================
-- 4) คำถาม 10 ข้อ พร้อมตัวเลือก (ข้อที่ถูกมี is_correct = true)
-- ============================================================
...
-- รีเซ็ต sequence ให้ตรงกับ id ล่าสุด
